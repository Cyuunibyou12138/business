			...
			<div class="order-body">
				...
				<div class="order-right">
					<div class="order-content">
						...
						<div class="orders">
							<table class="order-item" v-for="order in ordersList" :key="order.id">
								<thead>
									<tr>
										<th colspan="5">
									...
									<tr v-for="(orderDetail,index) in order.orderDetailList" :key="orderDetail.id">
										<td width="60%" >
											<div class="typographic" >
												<img :src="orderDetail.imgUrl" width="82px"/>
...
<script>
	export default {
      ...
      getprice(){
        let price = 0
        this.ordersList.forEach(item1=>{
          item1.orderDetailList.forEach(item2=>{
            price=price+ item2.skuNum*item2.orderPrice
          })
        })
        this.price = price
      },
			getList() {
				this.axios.get(`/api/order/auth/1/10`).then(res => {
